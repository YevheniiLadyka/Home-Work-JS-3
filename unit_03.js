...
function f3(){
    let data3 = +document.querySelector('.i-31').value;
    let data4 = +document.querySelector('.i-32').value;
    let out3 = document.querySelector('.out-3');
    if (data3 > data4) {
        out3.innerHTML = data3;
    } else {
        out3.innerHTML = data4;
    }
}
...
function f5(){
let data5 = document.querySelector('.i-5').value;
...
function f6(){
let data6 = document.querySelector('.i-6').value;
...
function f7(){
    let data7 = +document.querySelector('.i-71').value;
    let data8 = +document.querySelector('.i-72').value;
    let out7 = document.querySelector('.out-7');
    out7.innerHTML = data7 ** data8;
...
let data8 =+document.querySelector('.s-8').value;
switch (data8) {
    case 1:
        out8.innerHTML = 'one';
        break;
...
if (data9 >= 1 && data9 <= 32) {
    out9.innerHTML = 1;
} else if (data9 >= 33 && data9 <= 43) {
    out9.innerHTML = 2;
} else if (data9 >= 44 && data9 <= 64) {
    out9.innerHTML = 3;
} else {
    out9.innerHTML = 0;
}
...
let data10 = document.querySelector('.s-100').value;
out10.innerHTML = data10;
}
...
let data11 = document.querySelector('.s-110').value;
out11.innerHTML = data11;
}
...
let data13 = document.querySelector('.i-130');

function f13(){
let z = data13.value;
/* let z = +data13.value - если сделать так, вместо варианта выше, то тип данных будет number */
...
function f14(){
 let data14 = +document.querySelector('.i-141').value;
 let data15 = +document.querySelector('.i-142').value;
 let op = document.querySelector('.s-143').value;
 let out14 = document.querySelector('.out-14');
 switch (op) {
    case '+':
        out14.innerHTML = data14 + data15;
        break;
    case '-':
        out14.innerHTML = data14 - data15;
        break;
...
function f15(){
    let data16 = +document.querySelector('.s-151').value;
    let data17 = +document.querySelector('.s-152').value;
    let op2 = document.querySelector('.s-153').value;
 
    let out15 = document.querySelector('.out-15');
    switch (op2) {
       case '&&':
          out15.innerHTML = data16 && data17;
          break;
       case '||':
          out15.innerHTML = data16 || data17;
          break;
